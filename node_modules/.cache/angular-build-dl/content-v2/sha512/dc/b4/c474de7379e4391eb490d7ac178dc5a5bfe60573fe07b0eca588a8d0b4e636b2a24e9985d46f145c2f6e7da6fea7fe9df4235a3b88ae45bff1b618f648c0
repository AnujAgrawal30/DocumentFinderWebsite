...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppHomeHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div ><button (click)='addDirectory()'>Add a directory</button></div>\n<div><button (click)='searchKeyword()'>Search for Files</button></div>\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTagTagComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAddAddComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _network_calls_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../network-calls.service */
    ...
    /*#__PURE__*/
    function () {
      function AddComponent(network_service, _location) {
      ...
      _createClass(AddComponent, [{
        ...
        key: "trainPath",
        value: function trainPath(path) {
          var _this = this;

          this.loading = true;
          this.done = false;
          console.log(path);
          this.network_service.addTrainPath(path).subscribe(function (data) {
            console.log(data);
            _this.loading = false;
            _this.done = true;
          });
        ...
        key: "trainPathDB",
        value: function trainPathDB(path) {
          var _this2 = this;

          this.loadingDB = true;
          this.doneDB = false;
          console.log(path);
          this.network_service.addTrainPathDB(path).subscribe(function (data) {
            console.log(data);
            _this2.loadingDB = false;
            _this2.doneDB = true;
          });
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _search_search_component__WEBPACK_IMPORTED_MODULE_5__["SearchComponent"], _add_add_component__WEBPACK_IMPORTED_MODULE_7__["AddComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_8__["HomeComponent"], _tag_tag_component__WEBPACK_IMPORTED_MODULE_9__["TagComponent"]],
  ...
  /***/
  function srcAppNetworkCallsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NetworkCallsService", function () {
      return NetworkCallsService;
    });
    /* harmony import */
    ...
    var NetworkCallsService =
    /*#__PURE__*/
    function () {
      function NetworkCallsService(http) {
        _classCallCheck(this, NetworkCallsService);

        this.http = http;
        this.BASE_URL = "http://127.0.0.1:8000";
      }

      _createClass(NetworkCallsService, [{
        key: "getSearchResults",
        value: function getSearchResults(query, method) {
        ...
        key: "addTrainPath",
        value: function addTrainPath(path) {
          return this.http.get(this.BASE_URL + '/train', {
            params: {
              path: path
            }
          });
        ...
        key: "addTrainPathDB",
        value: function addTrainPathDB(path) {
          return this.http.get(this.BASE_URL + '/train', {
            params: {
              path: path
            }
        ...
        key: "test",
        value: function test() {
          this.http.get(this.BASE_URL).subscribe(function (data) {
            console.log(data);
          });
        }
      }, {
        key: "addTag",
        value: function addTag(tag, filepath) {
    ...
    NetworkCallsService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    NetworkCallsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], NetworkCallsService);
    /***/
  },
  ...
  function srcAppSearchSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _network_calls_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../network-calls.service */
    "./src/app/network-calls.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function SearchComponent(http, network_service, _location, router) {
      ...
      _createClass(SearchComponent, [{
        ...
        key: "sendMsg",
        value: function sendMsg(query) {
          var _this3 = this;

          console.log(query);
          this.noResultFound = false;
          this.results = [];
          this.network_service.getSearchResults(query, 'name').subscribe(function (data) {
            ...
            data.forEach(function (item) {
              _this3.results.push(item);
            });
          });
          console.log("Sent request for name");
          this.network_service.getSearchResults(query, 'tag').subscribe(function (data) {
            data.forEach(function (item) {
              if (_this3.results.find(_this3.listEqual, item.path)) {
                return;
              }
          ...
          this.network_service.getSearchResults(query, 'text').subscribe(function (data) {
            data.forEach(function (item) {
              if (_this3.results.find(_this3.listEqual, item.path)) {
                return;
              }
          ...
          this.network_service.getSearchResults(query, 'similar').subscribe(function (data) {
            console.log(data.length);
            data.forEach(function (item) {
              _this3.results.push(item);
            });
        ...
        key: "listEqual",
        value: function listEqual(value) {
  ...
  /***/
  function srcAppTagTagComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppTagTagComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function TagComponent(route, network_service, _location) {
      ...
      _createClass(TagComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.network_service.getFileInfo(this.id).subscribe(function (response) {
            _this4.fileInfo = response;
          });
        }
      }, {
        key: "getInfo",
        value: function getInfo() {
          ...
          this.network_service.getFileInfo(this.id).subscribe(function (response) {
            ...
            _this5.fileInfo = response;
          });
        }
      }, {
        key: "addTag",
        value: function addTag(tag, item) {
          var _this6 = this;

          this.network_service.addTag(tag, item.path).subscribe(function (response) {
            if (response) {
              _this6.fileInfo.tags += " " + tag;
    ...
    TagComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/tag/tag.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./tag.component.css */
      "./src/app/tag/tag.component.css")).default]
    })], TagComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\anuj\Desktop\Python\DocumentFinder\documentFinderAngular\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
